      ...
      <section className="w-full bg-white py-24 md:py-32 px-6 md:px-12 border-y border-gray-200">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3 flex flex-col justify-center">
            ...
            <div className="w-16 h-1.5 bg-primary-red mb-10 shadow-md"></div>
            
            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
              <ul className="space-y-3">
                {leftCities.map(c => (
                  <li key={c} className="text-gray-600 font-bold uppercase tracking-wider text-[10px] sm:text-xs">
                    <span className="text-primary-red mr-2 font-black">•</span> {c}
                  </li>
                ))}
              </ul>
              <ul className="space-y-3">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
          ...
          <div className="flex flex-col justify-center text-white lg:pl-10">
            ...
            <div className="space-y-10 text-gray-300 text-lg font-serif">
              <p className="border-l-4 border-primary-red pl-6 py-2 italic text-xl">Red Stag Construction operates across Greater Los Angeles specializing in high-end design-build frameworks.</p>
              
              <div>
                <span className="block text-xs font-sans font-bold uppercase tracking-widest text-[#B31217] mb-2">Direct Line</span>
                <a href="tel:6266522303" className="text-3xl md:text-4xl font-extrabold text-white hover:text-primary-red transition-colors tracking-wider">(626) 652-2303</a>
              </div>
              
              <div>
                <span className="block text-xs font-sans font-bold uppercase tracking-widest text-[#B31217] mb-2">Email</span>
                <a href="mailto:support@redstagcc.com" className="text-xl md:text-2xl font-extrabold text-white hover:text-primary-red transition-colors tracking-wider">support@redstagcc.com</a>
              </div>
            ...
            <div className="flex space-x-6 mt-16 border-t border-gray-800 pt-10">
              <a href="#" aria-label="Instagram" className="w-14 h-14 bg-black border border-gray-800 flex items-center justify-center hover:border-primary-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
                <svg className="w-5 h-5 text-gray-400 group-hover:text-primary-red transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.20 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
              </a>
              <a href="#" aria-label="Facebook" className="w-14 h-14 bg-black border border-gray-800 flex items-center justify-center hover:border-primary-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
              ...
              <a href="#" aria-label="LinkedIn" className="w-14 h-14 bg-black border border-gray-800 flex items-center justify-center hover:border-primary-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
