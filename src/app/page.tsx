        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
          ...
          <div className="flex flex-col justify-center text-white lg:pl-10">
            ...
            <div className="flex space-x-6 mt-16 border-t border-gray-800 pt-10">
              <a href="https://www.instagram.com/redstagcc" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-14 h-14 bg-navy-deep border border-gray-800 flex items-center justify-center hover:border-accent-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
              ...
              <a href="https://www.facebook.com/Redstagconstructioncompany" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-14 h-14 bg-navy-deep border border-gray-800 flex items-center justify-center hover:border-accent-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
              ...
              <a href="https://www.linkedin.com/in/israel-aquino-59333259" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-14 h-14 bg-navy-deep border border-gray-800 flex items-center justify-center hover:border-accent-red transition-colors group shadow-lg hover:-translate-y-1 transform duration-300">
