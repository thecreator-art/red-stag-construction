    ...
    <>
      ...
      <section className="bg-cream py-24 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/3 opacity-5 pointer-events-none w-[800px] h-[800px]">
          <svg viewBox="0 0 100 100" className="w-full h-full fill-current text-primary-dark">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 bg-primary-dark text-white p-12 border-t-8 border-primary-red shadow-xl">
              <h2 className="text-3xl font-serif font-bold mb-8">Contact Information</h2>
              
              <div className="space-y-10">
                <div>
                  <h3 className="text-gold font-bold uppercase tracking-widest text-sm mb-2">Phone Directory</h3>
                  <a href="tel:6266522303" className="block text-3xl font-bold hover:text-gold transition-colors">(626) 652-2303</a>
                  <p className="text-gray-400 text-sm mt-2">Mon - Fri: 9:00 AM - 6:00 PM<br/>Sat: 9:00 AM - 3:00 PM</p>
                </div>

                <div>
                  <h3 className="text-gold font-bold uppercase tracking-widest text-sm mb-2">Email Address</h3>
                  <a href="mailto:support@redstagcc.com" className="block text-xl hover:text-gold transition-colors">support@redstagcc.com</a>
                </div>

                <div>
                  <h3 className="text-gold font-bold uppercase tracking-widest text-sm mb-2">Corporate Office</h3>
            ...
            <div className="lg:col-span-7 bg-white p-12 border border-gray-200 shadow-xl">
              <h2 className="text-3xl font-serif font-bold text-primary-dark mb-2">Request an Estimate</h2>
              <p className="text-body-grey mb-8">Ready to build? Fill out the form below and we will contact you shortly.</p>
