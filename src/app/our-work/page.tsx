...
export default function OurWork() {
  return (
    <>
      ...
      <section className="bg-primary-dark pt-12 pb-24 border-b border-gray-800 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto mt-16">
            ...
            <div className="bg-black border border-gray-800 overflow-hidden">
              ...
              />
              <div className="p-8">
                <span className="text-gold font-bold uppercase tracking-widest text-sm mb-2 block">Kitchen Remodel</span>
            ...
            <div className="bg-black border border-gray-800 overflow-hidden">
              ...
              />
              <div className="p-8">
                <span className="text-gold font-bold uppercase tracking-widest text-sm mb-2 block">Bathroom Remodel</span>
            ...
            <div className="bg-black border border-gray-800 overflow-hidden">
              ...
              />
              <div className="p-8">
                <span className="text-gold font-bold uppercase tracking-widest text-sm mb-2 block">ADU Construction</span>
            ...
            <div className="bg-black border border-gray-800 overflow-hidden">
              ...
              />
              <div className="p-8">
                <span className="text-gold font-bold uppercase tracking-widest text-sm mb-2 block">Home Addition</span>
