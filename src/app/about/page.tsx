    ...
    <>
      ...
      <section className="py-24 bg-cream">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary-dark mb-8">The Team Behind Your Project</h2>
          <p className="text-lg text-body-grey mb-16 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
            <div className="bg-white border border-gray-200 overflow-hidden shadow-sm">
              <div className="relative h-80 w-full">
                <Image src="/images/team/israel-aquino-red-stag-construction-founder-01.jpg" alt="Israel Aquino — Founder and General Contractor" fill sizes="33vw" className="object-cover object-top filter grayscale" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark mb-1">Israel Aquino</h3>
                <p className="text-sm font-bold text-primary-red uppercase tracking-wide mb-4">Founder, CEO & Prime Contractor</p>
            ...
            <div className="bg-white border border-gray-200 overflow-hidden shadow-sm">
              <div className="relative h-80 w-full">
                <Image src="/images/team/anthony-torsarkissian.jpg" alt="Anthony Torsarkissian — COO" fill sizes="33vw" className="object-cover object-top filter grayscale" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark mb-1">Anthony Torsarkissian</h3>
                <p className="text-sm font-bold text-primary-red uppercase tracking-wide mb-4">COO & Prime Contractor</p>
                <p className="text-body-grey text-sm leading-relaxed">
            ...
            <div className="bg-white border border-gray-200 overflow-hidden shadow-sm">
              <div className="relative h-80 w-full">
                <Image src="/images/team/zack-ward.jpg" alt="Zack Ward — Head of Project Development" fill sizes="33vw" className="object-cover object-top filter grayscale" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark mb-1">Zack Ward</h3>
                <p className="text-sm font-bold text-primary-red uppercase tracking-wide mb-4">Head of Project Development</p>
                <p className="text-body-grey text-sm leading-relaxed">
